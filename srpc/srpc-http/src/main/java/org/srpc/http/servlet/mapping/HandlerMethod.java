...
public class HandlerMethod {
	protected final Log logger = LogCore.BASE;
	...
	/**
	 * Create an instance from a bean name, a method, and a {@code BeanFactory}. The method {@link #createWithResolvedBean()} may be used later to re-create
	 * the {@code HandlerMethod} with an initialized bean.
	 */
	...
	/**
	 * If the bean method is a bridge method, this method returns the bridged (user-defined) method. Otherwise it returns the same method as
	 * {@link #getMethod()}.
	 */
	 ...
	 * <p>
	 * Also supports <em>merged</em> composed annotations with attribute overrides as of Spring Framework 4.2.2.
	 * 
	...
	/**
	 * If the provided instance contains a bean name rather than an object instance, the bean name is resolved before a {@link HandlerMethod} is created and
	 * returned.
	 */
